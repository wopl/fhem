...
#####################################
sub
InfluxDBLogS_Initialize($)
{
  my ($hash) = @_;

  $hash->{DefFn}    = "InfluxDBLogS_Define";
  $hash->{NotifyFn} = "InfluxDBLogS_Log";
  $hash->{AttrFn}   = "InfluxDBLogS_Attr";
...
InfluxDBLogS_Define($@)
{
  ...
  return "wrong syntax: define <name> InfluxDBLogS InfluxDBServer InfluxDBPort InfluxDatabase Username Password regexp"
      if(int(@a) != 8);
...
<a name="InfluxDBLogS"></a>
<h3>InfluxDBLogS</h3>
<ul>
  <br>

  <a name="InfluxDBLogSdefine"></a>
  <b>Define</b>
  <ul>
    <code>define &lt;name&gt; InfluxDBLogS &lt;InfluxDBServer&gt; &lt;InfluxDBPort&gt; &lt;InfluxDatabase&gt; &lt;Username&gt; &lt;Password&gt; &lt;regexp&gt;
    </code>
    <br><br>
